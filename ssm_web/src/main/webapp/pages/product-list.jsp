...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<script type="text/javascript">
        function del(id) {
            if(confirm("确定删除?")){
                location.href="${pageContext.request.contextPath}/product/del?id="+id;
            }
        }
        ...
        function gotoPage(num) {
            ...
            if(num>${pageInfo.lastPage}){
                return;
            }
              ps = $("#pageSize").val();
            location.href="${pageContext.request.contextPath}/product/findAll?pageNumber="+num+"&pageSize="+ps;
